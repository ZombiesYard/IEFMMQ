...
def _build_fa18c_run005_composition_rebalance_122_plan() -> list[CapturePlanItem]:
    total = 122
    non_target = "EW/SA/RADAR/STORES/MIDS/DATA/FPAS/CHKLIST or stable blank"
    stable_blank = "non-target page or stable blank"
    specs = [
        {
            "count": 12,
            "category_id": "default_TAC_HSI_MAP_BITROOT",
            "category_name": "Default cold-start TAC + HSI MAP + BIT root",
            "target_display": "all",
            "left_ddi_content": "TAC / TAC MENU",
            "ampcd_content": "HSI with MAP overlay; no OK.",
            "right_ddi_content": "BIT FAILURES / BIT root",
            "expected_primary_content": "TAC + HSI MAP + BIT root",
            "expected_other_displays": "Realistic default cold-start multi-fact composition.",
            "expected_key_facts": "tac_page_visible=seen; hsi_page_visible=seen; hsi_map_layer_visible=seen; bit_root_page_visible=seen",
            "capture_instruction": "Set left DDI to TAC, AMPCD to HSI with MAP overlay, and right DDI to BIT FAILURES / BIT root.",
        },
        {
            "count": 10,
            "category_id": "SUPT_HSI_MAP_BITROOT",
            "category_name": "SUPT + HSI MAP + BIT root",
            "target_display": "all",
            "left_ddi_content": "SUPT page",
            "ampcd_content": "HSI with MAP overlay; no OK.",
            "right_ddi_content": "BIT FAILURES / BIT root",
            "expected_primary_content": "SUPT + HSI MAP + BIT root",
            "expected_other_displays": "Navigation context with BIT root still visible.",
            "expected_key_facts": "supt_page_visible=seen; hsi_page_visible=seen; hsi_map_layer_visible=seen; bit_root_page_visible=seen",
            "capture_instruction": "Set left DDI to SUPT, AMPCD to HSI with MAP overlay, and right DDI to BIT root.",
        },
        {
            "count": 10,
            "category_id": "FCS_X_HSI_MAP_BITROOT",
            "category_name": "FCS with X marks + HSI MAP + BIT root",
            "target_display": "all",
            "left_ddi_content": "FCS page with obvious X/fault fills",
            "ampcd_content": "HSI with MAP overlay; no OK.",
            "right_ddi_content": "BIT FAILURES / BIT root",
            "expected_primary_content": "FCS X + HSI MAP + BIT root",
            "expected_other_displays": "FCS page and BIT root co-occur with HSI MAP.",
            "expected_key_facts": "fcs_page_visible=seen; fcs_page_x_marks_visible=seen; hsi_page_visible=seen; hsi_map_layer_visible=seen; bit_root_page_visible=seen",
            "capture_instruction": "Set left DDI to true FCS page before reset with X marks; keep HSI MAP on AMPCD and BIT root on right DDI.",
        },
        {
            "count": 8,
            "category_id": "FCS_NOX_HSI_GRND_BITROOT",
            "category_name": "FCS without X + HSI GRND + BIT root",
            "target_display": "all",
            "left_ddi_content": "FCS page without obvious X/fault fills",
            "ampcd_content": "HSI MAP off; GRND/QUAL/TIME visible; no OK.",
            "right_ddi_content": "BIT FAILURES / BIT root",
            "expected_primary_content": "FCS no-X + HSI GRND + BIT root",
            "expected_other_displays": "Reset-cleared FCS page with alignment-running hard negative.",
            "expected_key_facts": "fcs_page_visible=seen; fcs_page_x_marks_visible=not_seen; hsi_page_visible=seen; ins_grnd_alignment_text_visible=seen; bit_root_page_visible=seen; ins_ok_text_visible=not_seen",
            "capture_instruction": "Set left DDI to FCS without obvious X marks, AMPCD to HSI MAP off with GRND/QUAL/TIME, and right DDI to BIT root.",
        },
        {
            "count": 8,
            "category_id": "FCS_X_HSI_GRND_FCSMC_PBIT",
            "category_name": "FCS X + HSI GRND + FCS-MC PBIT",
            "target_display": "all",
            "left_ddi_content": "FCS page with obvious X/fault fills",
            "ampcd_content": "HSI MAP off; GRND/QUAL/TIME visible; no OK.",
            "right_ddi_content": "FCS-MC page with PBIT GO",
            "expected_primary_content": "FCS X + HSI GRND + FCS-MC PBIT",
            "expected_other_displays": "PBIT GO is an intermediate status, not final GO.",
            "expected_key_facts": "fcs_page_visible=seen; fcs_page_x_marks_visible=seen; hsi_page_visible=seen; ins_grnd_alignment_text_visible=seen; fcsmc_page_visible=seen; fcsmc_intermediate_result_visible=seen; fcsmc_final_go_result_visible=not_seen",
            "capture_instruction": "Set left DDI to FCS with X marks, AMPCD to HSI GRND no OK, and right DDI to FCS-MC PBIT GO.",
        },
        {
            "count": 7,
            "category_id": "SUPT_HSI_GRND_FCSMC_PBIT",
            "category_name": "SUPT + HSI GRND + FCS-MC PBIT",
            "target_display": "all",
            "left_ddi_content": "SUPT page",
            "ampcd_content": "HSI MAP off; GRND/QUAL/TIME visible; no OK.",
            "right_ddi_content": "FCS-MC page with PBIT GO",
            "expected_primary_content": "SUPT + HSI GRND + FCS-MC PBIT",
            "expected_other_displays": "SUPT navigation context with PBIT hard negative.",
            "expected_key_facts": "supt_page_visible=seen; hsi_page_visible=seen; ins_grnd_alignment_text_visible=seen; fcsmc_page_visible=seen; fcsmc_intermediate_result_visible=seen; fcsmc_final_go_result_visible=not_seen",
            "capture_instruction": "Set left DDI to SUPT, AMPCD to HSI GRND no OK, and right DDI to FCS-MC PBIT GO.",
        },
        {
            "count": 8,
            "category_id": "TAC_HSI_GRND_FCSMC_INTEST",
            "category_name": "TAC + HSI GRND + FCS-MC IN TEST",
            "target_display": "all",
            "left_ddi_content": "TAC / TAC MENU",
            "ampcd_content": "HSI MAP off; GRND/QUAL/TIME visible; no OK.",
            "right_ddi_content": "FCS-MC page showing IN TEST",
            "expected_primary_content": "TAC + HSI GRND + FCS-MC IN TEST",
            "expected_other_displays": "IN TEST is running, not final GO.",
            "expected_key_facts": "tac_page_visible=seen; hsi_page_visible=seen; ins_grnd_alignment_text_visible=seen; fcsmc_page_visible=seen; fcsmc_in_test_visible=seen; fcsmc_final_go_result_visible=not_seen",
            "capture_instruction": "Set left DDI to TAC, AMPCD to HSI GRND no OK, and right DDI to FCS-MC IN TEST.",
        },
        {
            "count": 7,
            "category_id": "FCS_NOX_HSI_GRND_FCSMC_INTEST",
            "category_name": "FCS no-X + HSI GRND + FCS-MC IN TEST",
            "target_display": "all",
            "left_ddi_content": "FCS page without obvious X/fault fills",
            "ampcd_content": "HSI MAP off; GRND/QUAL/TIME visible; no OK.",
            "right_ddi_content": "FCS-MC page showing IN TEST",
            "expected_primary_content": "FCS no-X + HSI GRND + FCS-MC IN TEST",
            "expected_other_displays": "FCS page co-occurs with running FCS-MC BIT.",
            "expected_key_facts": "fcs_page_visible=seen; hsi_page_visible=seen; ins_grnd_alignment_text_visible=seen; fcsmc_page_visible=seen; fcsmc_in_test_visible=seen; fcsmc_final_go_result_visible=not_seen",
            "capture_instruction": "Set left DDI to FCS without obvious X marks, AMPCD to HSI GRND no OK, and right DDI to FCS-MC IN TEST.",
        },
        {
            "count": 9,
            "category_id": "SUPT_HSI_GRND_FCSMC_FINALGO",
            "category_name": "SUPT + HSI GRND + FCS-MC final GO",
            "target_display": "all",
            "left_ddi_content": "SUPT page",
            "ampcd_content": "HSI MAP off; GRND/QUAL/TIME visible; no OK.",
            "right_ddi_content": "FCS-MC page with final GO",
            "expected_primary_content": "SUPT + HSI GRND + FCS-MC final GO",
            "expected_other_displays": "FCS-MC final GO does not imply INS OK.",
            "expected_key_facts": "supt_page_visible=seen; hsi_page_visible=seen; ins_grnd_alignment_text_visible=seen; ins_ok_text_visible=not_seen; fcsmc_page_visible=seen; fcsmc_final_go_result_visible=seen",
            "capture_instruction": "Set left DDI to SUPT, AMPCD to HSI GRND no OK, and right DDI to FCS-MC final GO.",
        },
        {
            "count": 7,
            "category_id": "FCS_NOX_HSI_GRND_FCSMC_FINALGO",
            "category_name": "FCS no-X + HSI GRND + FCS-MC final GO",
            "target_display": "all",
            "left_ddi_content": "FCS page without obvious X/fault fills",
            "ampcd_content": "HSI MAP off; GRND/QUAL/TIME visible; no OK.",
            "right_ddi_content": "FCS-MC page with final GO",
            "expected_primary_content": "FCS no-X + HSI GRND + FCS-MC final GO",
            "expected_other_displays": "FCS-MC final GO with INS no-OK hard negative.",
            "expected_key_facts": "fcs_page_visible=seen; hsi_page_visible=seen; ins_grnd_alignment_text_visible=seen; ins_ok_text_visible=not_seen; fcsmc_page_visible=seen; fcsmc_final_go_result_visible=seen",
            "capture_instruction": "Set left DDI to FCS without obvious X marks, AMPCD to HSI GRND no OK, and right DDI to FCS-MC final GO.",
        },
        {
            "count": 6,
            "category_id": "FCSMC_FINALGO_HSI_OK",
            "category_name": "FCS-MC final GO + HSI OK",
            "target_display": "all",
            "left_ddi_content": stable_blank,
            "ampcd_content": "HSI with clear OK near QUAL/GRND block",
            "right_ddi_content": "FCS-MC page with final GO",
            "expected_primary_content": "FCS-MC final GO + HSI OK",
            "expected_other_displays": "Small number of dual-complete positives.",
            "expected_key_facts": "hsi_page_visible=seen; ins_grnd_alignment_text_visible=seen; ins_ok_text_visible=seen; fcsmc_page_visible=seen; fcsmc_final_go_result_visible=seen",
            "capture_instruction": "Capture a clear HSI OK on AMPCD together with FCS-MC final GO on right DDI.",
        },
        {
            "count": 4,
            "category_id": "TAC_HSI_OK_NO_FCSMC",
            "category_name": "TAC + HSI OK without FCS-MC",
            "target_display": "all",
            "left_ddi_content": "TAC / TAC MENU",
            "ampcd_content": "HSI with clear OK near QUAL/GRND block",
            "right_ddi_content": stable_blank,
            "expected_primary_content": "TAC + HSI OK, no FCS-MC",
            "expected_other_displays": "INS OK should not require FCS-MC page.",
            "expected_key_facts": "tac_page_visible=seen; hsi_page_visible=seen; ins_grnd_alignment_text_visible=seen; ins_ok_text_visible=seen; fcsmc_page_visible=not_seen",
            "capture_instruction": "Set left DDI to TAC, AMPCD to clear HSI OK, and right DDI to non-target or blank.",
        },
        {
            "count": 4,
            "category_id": "SUPT_HSI_OK_NO_FCSMC",
            "category_name": "SUPT + HSI OK without FCS-MC",
            "target_display": "all",
            "left_ddi_content": "SUPT page",
            "ampcd_content": "HSI with clear OK near QUAL/GRND block",
            "right_ddi_content": stable_blank,
            "expected_primary_content": "SUPT + HSI OK, no FCS-MC",
            "expected_other_displays": "INS OK positive without FCS-MC co-occurrence.",
            "expected_key_facts": "supt_page_visible=seen; hsi_page_visible=seen; ins_grnd_alignment_text_visible=seen; ins_ok_text_visible=seen; fcsmc_page_visible=not_seen",
            "capture_instruction": "Set left DDI to SUPT, AMPCD to clear HSI OK, and right DDI to non-target or blank.",
        },
        {
            "count": 3,
            "category_id": "BITROOT_HSI_MAP_NO_FCSMC",
            "category_name": "BIT root + HSI MAP without FCS-MC",
            "target_display": "all",
            "left_ddi_content": "BIT FAILURES / BIT root",
            "ampcd_content": "HSI with MAP overlay; no OK.",
            "right_ddi_content": "non-target page or stable blank",
            "expected_primary_content": "BIT root + HSI MAP, no FCS-MC",
            "expected_other_displays": "Actual capture fallback: BIT root cannot be held together with FCS-MC in this setup.",
            "expected_key_facts": "bit_root_page_visible=seen; hsi_page_visible=seen; hsi_map_layer_visible=seen; fcsmc_page_visible=not_seen",
            "capture_instruction": "Set left DDI to BIT root, AMPCD to HSI MAP, and keep right DDI non-target or blank.",
        },
        {
            "count": 4,
            "category_id": "NONBITROOT_HSI_GRND_FCSMC_INTEST",
            "category_name": "HSI GRND + FCS-MC IN TEST without BIT root",
            "target_display": "all",
            "left_ddi_content": "TAC/SUPT/FCS/non-target page; avoid BIT root",
            "ampcd_content": "HSI MAP off; GRND/QUAL/TIME visible; no OK.",
            "right_ddi_content": "FCS-MC page showing IN TEST",
            "expected_primary_content": "HSI GRND + FCS-MC IN TEST, no BIT root",
            "expected_other_displays": "Actual capture fallback: FCS-MC IN TEST cannot be held together with BIT root in this setup.",
            "expected_key_facts": "bit_root_page_visible=not_seen; hsi_page_visible=seen; ins_grnd_alignment_text_visible=seen; fcsmc_page_visible=seen; fcsmc_in_test_visible=seen; ins_ok_text_visible=not_seen",
            "capture_instruction": "Keep BIT root absent; set AMPCD to HSI GRND no OK and right DDI to FCS-MC IN TEST.",
        },
        {
            "count": 8,
            "category_id": "MIXED_NON_TARGET",
            "category_name": "Mixed non-target pages",
            "target_display": "all",
            "left_ddi_content": non_target,
            "ampcd_content": "non-HSI page or stable blank",
            "right_ddi_content": non_target,
            "expected_primary_content": "No target page visible",
            "expected_other_displays": "Use EW/SA/RADAR/STORES/MIDS/DATA/FPAS/CHKLIST/blank; avoid all 13 target facts.",
            "expected_key_facts": "all 13 target facts should be not_seen if displays are readable",
            "capture_instruction": "Set all displays to non-target pages or stable blank; do not intentionally show TAC/SUPT/FCS/BIT/FCS-MC/HSI.",
        },
        {
            "count": 3,
            "category_id": "FCS_TRANSITION_UNREADABLE",
            "category_name": "FCS transition or unreadable",
            "target_display": "left_ddi",
            "left_ddi_content": "FCS page changing, blurred, cropped, or unreadable",
            "ampcd_content": stable_blank,
            "right_ddi_content": stable_blank,
            "expected_primary_content": "FCS unreadable transition",
            "expected_other_displays": "Actual tail capture: three FCS transition/unreadable frames.",
            "expected_key_facts": "fcs_page_visible=uncertain; fcs_page_x_marks_visible=uncertain",
            "capture_instruction": "Capture a page-change, blur, crop, or unreadable FCS frame.",
        },
        {
            "count": 1,
            "category_id": "BITROOT_TRANSITION_UNREADABLE",
            "category_name": "BIT root transition or unreadable",
            "target_display": "right_ddi",
            "left_ddi_content": stable_blank,
            "ampcd_content": stable_blank,
            "right_ddi_content": "BIT root changing, blurred, cropped, or unreadable",
            "expected_primary_content": "BIT root unreadable transition",
            "expected_other_displays": "Use this only for a genuine unreadable/transition frame.",
            "expected_key_facts": "bit_root_page_visible=uncertain",
            "capture_instruction": "Capture a page-change, blur, crop, or unreadable BIT root frame.",
        },
        {
            "count": 1,
            "category_id": "FCSMC_TRANSITION_UNREADABLE",
            "category_name": "FCS-MC transition or unreadable",
            "target_display": "right_ddi",
            "left_ddi_content": stable_blank,
            "ampcd_content": stable_blank,
            "right_ddi_content": "FCS-MC changing, blurred, cropped, or unreadable",
            "expected_primary_content": "FCS-MC unreadable transition",
            "expected_other_displays": "Actual tail capture: one FCS-MC transition/unreadable frame.",
            "expected_key_facts": "fcsmc_page_visible=uncertain; result facts uncertain if row text is unreadable",
            "capture_instruction": "Capture a page-change, blur, crop, or unreadable FCS-MC frame.",
        },
        {
            "count": 2,
            "category_id": "HSI_TRANSITION_UNREADABLE",
            "category_name": "HSI/INS transition or unreadable",
            "target_display": "ampcd",
            "left_ddi_content": stable_blank,
            "ampcd_content": "HSI/INS text changing, blurred, cropped, or unreadable",
            "right_ddi_content": stable_blank,
            "expected_primary_content": "HSI/INS unreadable transition",
            "expected_other_displays": "Actual tail capture: two HSI/INS transition/unreadable frames.",
            "expected_key_facts": "hsi_page_visible/hsi_map_layer_visible/ins_grnd_alignment_text_visible/ins_ok_text_visible may be uncertain",
            "capture_instruction": "Capture a page-change, blur, crop, or unreadable HSI/INS frame.",
        },
    ]
    if sum(int(spec["count"]) for spec in specs) != total:
        raise AssertionError("manual capture plan must contain exactly 122 items")
...
def _resolve_manual_plan(name: str) -> list[CapturePlanItem]:
    ...
    if normalized == "fa18c_run005_composition_rebalance_122":
        return _build_fa18c_run005_composition_rebalance_122_plan()
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        default="",
        help=(
            "Optional manual capture plan name. Supports fa18c_run003_v3_220 "
            "and fa18c_run005_composition_rebalance_122."
        ),
    )
    parser.add_argument(
