    ...
    return [
        Figure(
            ...
            (
                ...
                Box("bios", 210, 190, 170, 64, "Telemetry stream\nswitches, gauges,\nwarning lights", "data"),
        ...
        Figure(
            ...
            (
                ...
                Box("bios", 30, 200, 130, 56, "Simulator\ntelemetry stream", "sim"),
                ...
                Box("runtime", 400, 80, 170, 80, "Runtime\nhelp-cycle orchestration", "core"),
