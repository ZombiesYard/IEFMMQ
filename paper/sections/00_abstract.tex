...
F/A-18C cold-start procedure in DCS World and designs an evidence-grounded
tutoring runtime that integrates procedure-pack-driven state tracking,
retrieval-augmented help generation, and a fine-tuned vision-language model
(VLM) for structured visual fact extraction from cockpit displays. A central
finding is that visual fact ontology design governs
