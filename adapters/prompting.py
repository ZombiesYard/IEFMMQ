    ...
    *,
    ...
    if lang == "zh":
        ...
        rules = [
            ...
            "S18 分阶段判断时必须遵守：若已经进入 FCS-MC 页面但还未开始测试，才是“按住 FCS BIT 开关并按 PB5”这一步；在单目标模式下，优先高亮 PB5，而不是单独高亮 fcs_bit_switch。",
        ...
        rules = [
            ...
            "When reasoning about S18, obey this stage split: only after the right DDI has entered the FCS-MC page but before the BIT has started should you describe the action as 'hold FCS BIT and press PB5'. In single-target mode, prefer PB5 over highlighting fcs_bit_switch by itself.",
