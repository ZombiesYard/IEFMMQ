    ...
    *,
    ...
    if lang == "zh":
        ...
        rules = [
            ...
            "对于 S18，要明确区分流程：先在 BIT FAILURES / BIT root 页面按 PB5 进入 FCS-MC BIT 页，再按住 FCS BIT 开关并同时按 PB5 启动自检。仅仅看到 FCS-MC、PBIT GO、FCSA/FCSB 或右侧 GO 文案，不代表 S18 已完成。",
        ...
        rules = [
            ...
            "For S18, model the sequence explicitly: first press PB5 on the BIT FAILURES / BIT root page to enter the FCS-MC BIT page, then hold the FCS BIT switch and press PB5 to start the self-test. Seeing FCS-MC, PBIT GO, FCSA/FCSB, or right-side GO text alone does not mean S18 is complete.",
