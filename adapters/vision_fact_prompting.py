    ...
    *,
    ...
    if lang == "zh":
        rules = [
            ...
            "fcs_bit_result_visible 只有在右 DDI FCS-MC BIT 页面结果明确可读时才可为 seen；它属于 S18，不可拿来替代 S08 的 BIT root 页面。",
        ...
        rules = [
            ...
            "fcs_bit_result_visible may be seen only when the right DDI FCS-MC BIT result is readable; it belongs to S18 and must not replace the S08 BIT root page requirement.",
